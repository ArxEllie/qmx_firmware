...
// Backward-compatibility shims so legacy keymaps/configs that predate the
// IS31FL3733 driver rename keep compiling. New code should use the
// IS31FL3733_* / SW*_CS* names directly instead of these aliases.
#ifdef DRIVER_ADDR_1
...
// ======== DEPRECATED REGISTER ALIASES - DO NOT USE ========
// Legacy single-letter aliases (A=SW1 .. L=SW12) used by older keymaps.
#define A_1 SW1_CS1
#define A_2 SW1_CS2
#define A_3 SW1_CS3
#define A_4 SW1_CS4
