...
[1] = LAYOUT(
	...
	_______, 	LNK_BLE1,  	LNK_BLE2,  	LNK_BLE3,  	LNK_RF,	DEBOUNCE_PRESS_DEC,	DEBOUNCE_PRESS_INC,	DEBOUNCE_RELEASE_DEC,	DEBOUNCE_RELEASE_INC,   	_______,  	_______,   	_______,	_______, 	_______,	            _______,
	...
	_______,				_______,   	_______,   	_______,  	_______,    _______,   	_______,	MO(4), 		RM_SPDD,	RM_SPDU,	_______,	_______,	            RM_VALU,    _______,
